  ...
  <div class="relative">
    ...
    <div class="relative">
      ...
      <div v-else ref="selectTrigger"
        ...
        :class="{ 'opacity-50 cursor-not-allowed': disabled }" @click="!disabled && toggleDropdown()" tabindex="0"
        @keydown.space.prevent="!disabled && toggleDropdown()" @keydown.enter.prevent="!disabled && toggleDropdown()"
        @blur="handleBlur">
        <span v-if="multiple">
      ...
      <div class="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
        <svg class="w-4 h-4 text-gray-400" :class="{ 'transform rotate-180': isOpen }" fill="none" stroke="currentColor"
          viewBox="0 0 24 24">
      ...
      <div v-show="isOpen" ref="dropdown"
        ...
        <template v-if="filteredOptions.length">
          <div v-for="option in filteredOptions" :key="option.value" @click="!disabled && selectOption(option)"
            class="px-3 py-2 cursor-pointer hover:bg-whitten" :class="{
